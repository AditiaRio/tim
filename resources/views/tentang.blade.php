...
<head>
    ...
    <title>Tentang Kami - Minuman Kita</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1>Tentang Kami</h1>
                    <p>Minuman Kita adalah tempat untuk menemukan berbagai macam minuman dari seluruh dunia.
                        Kami menyediakan produk berkualitas terbaik dan pengalaman berbelanja yang luar biasa kepada
                        pelanggan kami.</p>
                    <p>Kami berkomitmen untuk menyediakan minuman berkualitas terbaik mulai dari kopi harum hingga
                        anggur elegan.</p>
                </div>
            </div>
        </div>
